...
[[ -f "$tmp/.colors/clickstack-fixture/compute/shared/backend.tf.json" ]]
...
# the CLICKSTACK_LIB_ROOT builds above reuse red/node_modules and cannot see a
# missing peer.
red_launcher="$root/skills/package-clickstack-red/red"
...
[[ -f "$tmp/red-cold/.colors/clickstack-fixture/compute/shared/backend.tf.json" ]]
